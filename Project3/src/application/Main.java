...
public class Main extends Application {
	...
	public static void read_Countries() throws FileNotFoundException {
		...
		File myObj = new File("2021-05-13 LatLONGT.txt");
...
///
		...
		try {
			...
			Image img = new Image(new File("worldF.png").toURI().toString());
...
//			for (int i = 0; i < countries.size(); i++) {
//				ArrayList<Country> pointetC = new ArrayList<Country>();
//				Random random = new Random();
//				pointetC.add(countries.get(i));
//				int randoom = random.nextInt(47);
//				if (randoom != i) {
//					pointetC.add(countries.get(randoom));
//				}
//				randoom = random.nextInt(47);
//				if (randoom != i) {
//					pointetC.add(countries.get(randoom));
//				}
//				randoom = random.nextInt(47);
...
//	private ArrayList<Integer>  getindexes(List<Vertex> list) {
//		ArrayList<Integer> indexes = new ArrayList<Integer>();
//		
//		for (int i = 0; i < list.size(); i++) {
//			indexes.addAll(countries.get(countries.indexOf(list.get(i).getCountry())));
//			
//			
//			
//		}
